...
- (void)setImgArr:(NSArray *)imgArr :(NSArray *)textArr{
    _marr = textArr;
    _imgArr = imgArr;
...
- (void)addScrollSubviews{
    ...
    for (NSInteger i = 0; i<self.imgArr.count; i++) {
        ...
        NSString *text  = self.marr[i];
        imgView.layer.cornerRadius = 15;
        imgView.layer.masksToBounds = YES;
        UILabel *lab =[[UILabel alloc] initWithFrame:CGRectMake(0, self.frame.size.height-15, self.imgWidth, 15)];
